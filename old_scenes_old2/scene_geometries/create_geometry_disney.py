...
Examples:
  ...
  python scenes/scene_geometries/create_geometry_disney.py \\
    -n 3000 -f scenes/scene_geometries/quad_2tri.obj \\
    -d -1 0 0 -k 40 -a 0 -10 1 -b 10 10 3 \\
    --bsdf diffuse -r 0.8 \\
    -o scenes/scene_geometries/quads-disney-diffuse-k40.xml -s 42
  ...
  python scenes/scene_geometries/create_geometry_disney.py \\
    ...
    -o scenes/scene_geometries/quads-disney-rough0.3-k40.xml -s 42
  ...
  python scenes/scene_geometries/create_geometry_disney.py \\
    ...
    -o scenes/scene_geometries/quads-disney-metal1.0-rough0.2-k40.xml -s 42
  ...
  python scenes/scene_geometries/create_geometry_disney.py \\
    ...
    -o scenes/scene_geometries/quads-disney-grouped-6clusters-k40.xml -s 42
  ...
  python scenes/scene_geometries/create_geometry_disney.py \\
    ...
    -o scenes/scene_geometries/quads-disney-heterogeneous-k40.xml -s 42
"""
