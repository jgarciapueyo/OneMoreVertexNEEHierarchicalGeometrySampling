...
Float computeNodeImportanceGroundTruth(
    ...
    for (int sampleIdx = 0; sampleIdx < numSamples; ++sampleIdx)
    {
        ...
        contributionSum += contribution / pdf_xp_temp;
    }

    Spectrum contributionAvg = contributionSum / (Float)numSamples;
    float luminanceContributionAvg = contributionAvg.getLuminance();
