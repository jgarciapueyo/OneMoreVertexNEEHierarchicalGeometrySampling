...
if __name__ == '__main__':
    ...
    for n_quads in [1, 50, 100, 300, 500, 1000, 5000, 10000]:
        write_scene(path=f'time_complexity_increasing_quads/scene_{n_quads}_quads.xml', integrator='doublestep', simple_geo_level=2,
                    samples=256, resx=512, fov=45, checkerboard=True, n_quads=n_quads,
                    light_mode=3)